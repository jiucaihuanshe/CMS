...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			<a href="${basePath }/Admin/main.do" class="logo"> <span
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="${basePath }/static/images/user2-160x160.jpg"
								class="user-image" alt="User Image"> <span
								class="hidden-xs">${staff_name }</span>
						</a>
							<ul class="dropdown-menu">
								...
								<li class="user-footer">
									<div class="pull-left">
										<a
											href="javascript:myselfinfo('${basePath }/Account/doShowUserInfo.do?id=${staff_id}')"
											class="btn btn-default btn-flat">个人信息</a>
									</div>
									<div style="display: inline; margin-left: 20px;">
										<a href="javascript:showChangePwdDialog();"
											class="btn btn-default btn-flat">修改密码</a>
									</div>
									<div class="pull-right">
										<a href="${basePath }/Account/dologout.do"
		...
		<div class="modal-dialog" style="width: 600px;">
			<div class="modal-content">
				...
				<div class="modal-body" id="userModalContent"
					style="height: 450px; overflow-y: auto;"></div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="changePwdModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" style="width: 600px;">
			<div class="modal-content">
				...
				<div class="modal-body" id="changePwdModalContent"
					...
					<form class="form-horizontal" id="form-changepwd">
						...
						<div class="form-group">
							<label for="keywords" class="col-sm-3 control-label"> 确认密码：
							</label>
							<div class="col-sm-9">
	...
	<script type="text/javascript">
		...
		$(function(){		
			...
			$('#btnChangePwd').click(function(){
				...
				$.ajax({
					type:'post',
					url:sitePath+'/Account/doChangePassword.do',
					data:{newPassword:newPassword,id:userId},
					success:function(ret)
					{
						if(ret==='1')
						{
							layer.msg('修改成功', {icon: 1,time: 1000,},function(){
								...
								window.location=sitePath+"/Account/dologout.do";
							});						
						}
