...
public class ContextHelper
{
	...
	public final static String VALIDATECODE = "validate_code";
	...
	{
		setValue(VALIDATECODE, code);
	}

	public void removeValidateCode()
	{
		removeValue(VALIDATECODE);
	}

	public String getValidateCode()
	{
		Object validateCode = getValue(VALIDATECODE);
		return validateCode != null ? (String) validateCode : "";
	}
}
